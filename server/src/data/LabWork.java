...
public class LabWork implements Comparable<LabWork>, Serializable {
    ...
    public String update(){
        ...
        if (this.name.contains("v1.")){
            String[] labname = name.split("v1.");
            int numPart = Integer.parseInt(labname[1]);
            labname[1] = labname[1].replaceFirst(String.valueOf(numPart), String.valueOf(numPart + 1));
            this.name = labname[0] + "v1." + labname[1];
        }else {
            this.name += "v1.0";
        }
